...
class FitnessAdvisor:
    ...
    def __init__(self, api_key: str, endpoint_url: str):
        ...
        self.guaranteed_safe_replacements = [
            {"name": "Seated Hip Flexor March", "category": "Lower Body", "equipment": "Chair/Bodyweight", 
            ...
            {"name": "Wall Shoulder Blade Squeeze", "category": "Pull/Upper Body", "equipment": "Wall",
            ...
            {"name": "Standing Supported Calf Raises", "category": "Lower Body", "equipment": "Chair/Wall",
            ...
            {"name": "Seated Band Row", "category": "Pull/Upper Body", "equipment": "Resistance Band (if available)",
            ...
            {"name": "Glute Bridge (Small Range)", "category": "Core/Lower Body", "equipment": "Mat/Floor",
            ...
            {"name": "Controlled Torso Rotation (Seated)", "category": "Core", "equipment": "Chair/Bodyweight",
    ...
    def _normalize_exercise_name(self, name: str) -> bool:
        ...
        generic_terms = ['substituted', 'low-impact substitute', 'generic', 'variation', 'exercise', 'movement']
    ...
    def _post_process_and_validate_json(self, plan_json: Dict, user_profile: Dict, previous_plans: Dict) -> Dict:
        ...
        for i, exercise in enumerate(main_workout):
            ...
            if is_invalid:
                 ...
                 exercise['benefit'] = f"Auto-Corrected: {replacement['benefit'].replace('.', '')}. Original exercise was flagged for repetition or invalid equipment."
                 exercise['steps'] = replacement['steps']
        ...
        for category in required_categories:
            if category not in categories_present:
                for i in range(len(plan_json['main_workout'])):
                    ...
                    if self._categorize_exercise(plan_json['main_workout'][i]['name']) not in required_categories or plan_json['main_workout'][i]['name'].startswith("Controlled Marching"):
